...
var _macOs = require('../../style/theme/macOs');
...
var Checkbox = (_dec = (0, _ValueRef2.default)(), _dec2 = (0, _windowFocus2.default)(), _dec3 = (0, _hidden2.default)(), _dec4 = (0, _macOs.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _radium2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      ...
      var componentStyle = _extends({}, this.context.theme === 'dark' ? _2.default.checkboxDark : _2.default.checkbox, style);
      ...
      if (this.state.checked) {
        if (isWindowFocused) {
          componentStyle = _extends({}, componentStyle, this.context.theme === 'dark' ? _2.default['checkboxDark:checked'] : _2.default['checkbox:checked']);
          if (!transition) componentStyle.transition = 'none';
        } else {
          componentStyle = _extends({}, componentStyle, this.context.theme === 'dark' ? _2.default['checkboxDark:checked:unfocused'] : _2.default['checkbox:checked:unfocused']);
      ...
      if ((0, _radium.getState)(this.state, null, ':active')) {
        if (this.state.checked) {
          componentStyle = _extends({}, componentStyle, this.context.theme === 'dark' ? _2.default['checkboxDark:checked:active'] : _2.default['checkbox:checked:active']);
          if (this.context.theme != 'dark') {
            shadowColor = '#001d99';
          }
        } else {
          componentStyle = _extends({}, componentStyle, this.context.theme === 'dark' ? _2.default['checkboxDark:active'] : _2.default['checkbox:active']);
        }
      }
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _macOs3.default,
            { theme: this.context.theme, style: { display: 'inline' } },
            label
          )
        )
      );
  ...
  return Checkbox;
}(_react.Component), _class2.propTypes = _extends({}, _hidden.hiddenPropTypes, _macOs.themePropTypes, {
  label: _propTypes2.default.string,
  onChange: _propTypes2.default.func
}), _class2.contextTypes = _extends({}, _macOs.themeContextTypes), _temp)) || _class) || _class) || _class) || _class) || _class);
