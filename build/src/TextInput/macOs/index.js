...
var TextFieldOSX = (_dec = (0, _ValueRef2.default)(), _dec2 = (0, _hidden2.default)(), _dec3 = (0, _dimension2.default)(), _dec4 = (0, _windows.ThemeContext)(), _dec(_class = _dec2(_class = _dec3(_class = _dec4(_class = (0, _radium2.default)(_class = (_temp = _class2 = function (_Component) {
  ...
  _createClass(TextFieldOSX, [{
    ...
    value: function render() {
      ...
      if (this.context.theme === 'dark') {
        componentStyle = _extends({}, componentStyle, _2.default.textFieldDark);
      }
      ...
      if (this.state.isFocused && focusRing) {
        componentStyle = _extends({}, componentStyle, rounded ? this.context.theme === 'dark' ? _2.default.textFieldRoundedFocusDark : _2.default.textFieldRoundedFocus : this.context.theme === 'dark' ? _2.default.textFieldFocusDark : _2.default.textFieldFocus);
      ...
      var labelComponent = label ? _react2.default.createElement(
        _macOs4.default,
        { theme: this.context.theme, margin: '0 0 3px 0' },
        label
      ) : null;
        ...
        placeholderElement = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            this.state.showPlaceholder ? _react2.default.createElement(
              _macOs2.default,
              { theme: this.context.theme, color: '#c0c0c0', size: '12' },
              placeholder
            ) : null
          )
        );
  ...
  return TextFieldOSX;
}(_react.Component), _class2.propTypes = _extends({}, _windows.themePropTypes, _hidden.hiddenPropTypes, _margin.marginPropTypes, _dimension.dimensionPropTypes, _fontSize.fontSizePropTypes, {
...
}, _class2.contextTypes = _extends({}, _windows.themeContextTypes, {
